...
st.set_page_config(page_title="Studio Gaetani | Area Riservata", page_icon="🔒", layout="centered")
...
def check_password():
    ...
    def password_entered():
        ...
        # Se l'utente esiste e la password è giusta
...
# =========================================================
# DA QUI IN GIÙ INCOLLI IL CODICE DELLA TUA APP ORIGINALE
# (Tutto quello che c'era dopo set_page_config)
# =========================================================

# Esempio: Incolla qui tutto il resto del codice (CSS, Tabelle, Sidebar, Calcoli...)
# Nota: Rimuovi la riga 'st.set_page_config' dal codice vecchio perché l'abbiamo messa in cima.
...
with tab1:
    ...
    if st.button("CALCOLA NETTO", key="btn_avv_normale"):
        ...
        st.warning(f"⚠️ **Nota Integrativo:** In fattura dovrai aggiungere il 4% CPA (€ {cpa:,.2f}). Questa somma la incassi dal cliente ma la versi interamente alla Cassa, quindi non è reddito tuo.")
